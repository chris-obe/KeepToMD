...
import { StickyTopBar } from '@/components/feature/sticky-top-bar';
...
export default function Home() {
  return (
      <main className="min-h-screen w-full bg-background font-body text-foreground">
        <ApiSetupDialog />
        <StickyTopBar />
        <div className="container mx-auto flex max-w-6xl flex-col items-center p-4 py-8 sm:p-8 sm:py-12 md:p-12 md:py-16">
